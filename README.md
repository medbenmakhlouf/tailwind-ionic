...
| --icon-padding-top | ion-back-button | ion-back-button-pt-icon-* |
| --icon-margin-end | ion-back-button | ion-back-button-me-icon-* |
| --icon-margin-start | ion-back-button | ion-back-button-ms-icon-* |
| --icon-margin-top | ion-back-button | ion-back-button-mt-icon-* |
| --icon-padding-bottom | ion-back-button | ion-back-button-pb-icon-* |
| --icon-padding-end | ion-back-button | ion-back-button-pe-icon-* |
| --icon-padding-start | ion-back-button | ion-back-button-ps-icon-* |
| --icon-font-size | ion-back-button | ion-back-button-text-icon-size-* |
| --icon-font-weight | ion-back-button | ion-back-button-text-icon-weight-* |
| --icon-margin-bottom | ion-back-button | ion-back-button-mb-icon-* |
